...
#include "assignment_2_2023/CancelGoal.h"
...
bool cancelGoal=false; //used for the service
...
void shutdownHandler(int sig) 
{
 ...
 bool cancelGoal(assignment_2_2023::CancelGoal::Request &req, assignment_2_2023::CancelGoal::Response &res)
{
...
int main (int argc, char **argv)
	...
	ros::ServiceServer serviceCancelGoal= nh.advertiseService("/cancelGoal", cancelGoal); //initialize the ServiceServer  
	...
	while(ros::ok() && !g_shutdown_requested ) //continue while ros is ok and ctrl-c is not pressed
	{
		...
		assignment_2_2023::Parameters parameters; //define parameters
	  	parameters.pos_x=  pos_x*to_feet;
	  	parameters.pos_y = pos_y*to_feet;
