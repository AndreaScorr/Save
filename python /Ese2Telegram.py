...
Write a Ros node in python that sends a request to the service "/diagnostics", using the service message diagnostic_msgs/AddDiagnostics, by setting load_namespace to "robot". the node finally checks the field "succes" of the response and, if True, prints the field "message" on terminale
'''
